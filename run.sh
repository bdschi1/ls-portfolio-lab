#!/usr/bin/env bash
# ============================================================
# LS Portfolio Lab — Run Script
# ============================================================
# Usage:
#   ./run.sh              Setup environment and launch Streamlit app
#   ./run.sh setup        Install dependencies only
#   ./run.sh app          Launch Streamlit app only
...
# ── Setup ──────────────────────────────────────────────────
setup() {
    header "Setting up LS Portfolio Lab"
...
# ── App ────────────────────────────────────────────────────
run_app() {
    header "Launching LS Portfolio Lab"
    ...
    echo ""
    "${VENV_DIR}/bin/streamlit" run "${REPO_DIR}/app/main.py"
}
...
COMMANDS
    (none)      Setup environment and launch Streamlit app
    setup       Create venv and install dependencies
    app         Launch Streamlit app only (skip setup)
    test        Run the test suite
    help        Show this help message

EXAMPLES
    ./run.sh            # Setup + launch app
    ./run.sh setup      # Install deps only
    ./run.sh app        # Launch app (assumes setup done)
